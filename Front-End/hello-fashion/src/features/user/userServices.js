...
import {usePostDataWithoutAuth} from "../../common/hooks/api/usePostData";
import {usePostDataWithBasicAuth} from "../../common/hooks/api/usePostData";
...
export const register = createAsyncThunk(
  ...
  async (body, {rejectWithValue}) => {
    try {
      const res = await usePostDataWithoutAuth("/user/register", body);
